...
require github.com/metacubex/mihomo v0.0.0-20260420043800-1383218e2e3a
...
// Use the Vernesong Smart fork for builds. The module path remains
// github.com/metacubex/mihomo because that is what the fork declares.
replace github.com/metacubex/mihomo => github.com/vernesong/mihomo v0.0.0-20260420043800-1383218e2e3a
