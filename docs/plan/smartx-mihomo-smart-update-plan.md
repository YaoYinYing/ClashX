...
| read-only TUN runtime evidence | `TunRuntimeInterfaceProbe`, `TunRuntimeRouteProbe`, `TunRuntimeDNSProbe`, `TunLifecycleDiagnostics`, `DiagnosticsReportBuilder` | evidence only, not route ownership, DNS hijack, or packet proof |
